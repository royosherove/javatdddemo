...
public final class ClassModification
{
   ...
   private void registerModifiedClass(String className, ProtectionDomain protectionDomain)
   {
      modifiedClasses.add(className);

      if (protectionDomain.getCodeSource() != null && protectionDomain.getClassLoader() != null) {
